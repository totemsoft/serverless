...
public class SurveyApiImpl extends AbstractServiceImpl implements SurveyApi {
    ...
    @Override
    public ResponseEntity<UploadResponse> uploadMultipart(UUID reference, String folderId, String fileName, MultipartFile fileUpload) {
        final String refName = reference.toString();
        try {
            final String name = fileName; //fileUpload.getOriginalFilename();
            // TODO: get from http header "Content-Type"
